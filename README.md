...
| [`azure-ai-agent-operational`](./azure-ai-agent-operational) | Operational metrics for AI agent (token usage, run latency, tool calls). | Libraries adhere to [Opentelemetry GenAI Agent Spans](https://github.com/microsoft/opentelemetry-semantic-conventions/blob/main/docs/gen-ai/azure-ai-agent-spans.md) such as [Azure AI Agent Tracing](https://learn.microsoft.com/en-us/azure/ai-foundry/agents/concepts/tracing#observe-an-agent) |
| [`azure-ai-evaluation`](./azure-ai-evaluation) | AI-assisted quality & safety scores powered by [evaluators](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/observability#what-are-evaluators). | [Azure AI agent continuous evaluation](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/continuous-evaluation-agents) |
