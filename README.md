...
| [`ai-agent-operational`](./ai-agent-operational) | Operational metrics for AI agent (token usage, run latency, tool calls). | Libraries adhere to [Opentelemetry GenAI Agent Spans](https://github.com/microsoft/opentelemetry-semantic-conventions/blob/main/docs/gen-ai/ai-agent-spans.md) such as [Azure AI Agent Tracing](https://learn.microsoft.com/en-us/azure/ai-foundry/agents/concepts/tracing#observe-an-agent) |
